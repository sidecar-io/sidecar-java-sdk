...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private static final String TEST_APP_ACCESS_KEY = "ZZZIAJVUA2BSG37STKQZ";
    private static final String TEST_APP_SECRET_KEY = "Z8WbvvE8seGbXAdP0oWDgX/xqKuvEOwOpnHgrh1p";
    private static final AccessKey APP_KEYS = new AccessKey.Builder().keyId(TEST_APP_ACCESS_KEY).secret(TEST_APP_SECRET_KEY).build();
...
//                intent.putExtra("accesskeys", accessKey);
                startActivity(intent);
            } else {
